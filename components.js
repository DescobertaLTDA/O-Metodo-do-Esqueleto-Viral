...
(function () {
  ...
  var INLINE_COMPONENTS = {
    ...
    'footer.html': [
      ...
      '            <img src="/assets/img/compra_segura.png" alt="Kiwify" style="height:22px;width:auto;opacity:0.55;filter:brightness(1.2);">',
      '          </div>',
      '        </div>',
      ...
      '          <div style="height:64px;display:flex;align-items:center;justify-content:center;">',
      '            <img src="/assets/img/compra_segura.png" alt="Compra Segura" style="height:36px;width:auto;opacity:0.55;filter:brightness(1.2);">',
      '          </div>',
      '        </div>',
      '        <div style="width:1px;height:80px;background:rgba(255,255,255,0.06);flex-shrink:0;"></div>',
      '        <div style="display:flex;flex-direction:column;align-items:center;gap:10px;min-width:140px;">',
      ...
      '          <div style="height:64px;display:flex;align-items:center;justify-content:center;">',
      '            <img src="/assets/img/compra_segura.png" alt="Garantia 7 dias" style="height:64px;width:auto;opacity:0.85;">',
      '          </div>',
      '        </div>',
      '        <div style="width:1px;height:80px;background:rgba(255,255,255,0.06);flex-shrink:0;"></div>',
      '        <div style="display:flex;flex-direction:column;align-items:center;gap:10px;min-width:140px;">',
      ...
      '          <div style="height:64px;display:flex;align-items:center;justify-content:center;">',
      '            <img src="/assets/img/compra_segura.png" alt="Cartoes aceitos" style="height:44px;width:auto;opacity:0.7;filter:brightness(1.3);">',
      '          </div>',
      '        </div>',
      '      </div>',
