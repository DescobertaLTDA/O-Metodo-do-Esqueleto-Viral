...
(function () {
  ...
  var INLINE_COMPONENTS = {
    ...
    'footer.html': [
      ...
      '          <span style="font-size:9px;font-weight:700;letter-spacing:2px;text-transform:uppercase;color:rgba(255,255,255,0.2);">Plataforma de pagamento</span>',
      '          <div style="height:64px;display:flex;align-items:center;justify-content:center;">',
      '            <img src="https://res.cloudinary.com/dxzgkrshw/image/upload/v1773922208/logo_kiwify_branco-1024x269_g9jiz9.png" alt="Kiwify" style="height:22px;width:auto;opacity:0.55;filter:brightness(1.2);">',
      '          </div>',
      '        </div>',
      '        <div style="width:1px;height:80px;background:rgba(255,255,255,0.06);flex-shrink:0;"></div>',
      '        <div style="display:flex;flex-direction:column;align-items:center;gap:10px;min-width:140px;">',
      ...
      '          <div style="height:64px;display:flex;align-items:center;justify-content:center;">',
      '            <img src="https://res.cloudinary.com/dxzgkrshw/image/upload/v1773235629/compra-Segura-vetor-branco1-1_hw95bq.png" alt="Compra Segura" style="height:36px;width:auto;opacity:0.55;filter:brightness(1.2);">',
      '          </div>',
      '        </div>',
      '        <div style="width:1px;height:80px;background:rgba(255,255,255,0.06);flex-shrink:0;"></div>',
      '        <div style="display:flex;flex-direction:column;align-items:center;gap:10px;min-width:140px;">',
      '          <span style="font-size:9px;font-weight:700;letter-spacing:2px;text-transform:uppercase;color:rgba(255,255,255,0.2);">Garantia incondicional</span>',
      '          <div style="height:64px;display:flex;align-items:center;justify-content:center;">',
      '            <img src="https://res.cloudinary.com/dxzgkrshw/image/upload/v1774970992/Garantia-de-7-dias-Risco-ZERO_ff9e7d.png" alt="Garantia 7 dias" style="height:64px;width:auto;opacity:0.85;">',
      '          </div>',
      '        </div>',
      '        <div style="width:1px;height:80px;background:rgba(255,255,255,0.06);flex-shrink:0;"></div>',
      '        <div style="display:flex;flex-direction:column;align-items:center;gap:10px;min-width:140px;">',
      '          <span style="font-size:9px;font-weight:700;letter-spacing:2px;text-transform:uppercase;color:rgba(255,255,255,0.2);">Formas de pagamento</span>',
      '          <div style="height:64px;display:flex;align-items:center;justify-content:center;">',
      '            <img src="https://res.cloudinary.com/dxzgkrshw/image/upload/v1774970834/parada-feminina-cartoes-aceitos_eef06w.png" alt="Cartoes aceitos" style="height:44px;width:auto;opacity:0.7;filter:brightness(1.3);">',
      '          </div>',
      '        </div>',
      '      </div>',
