...
(function () {
  ...
  var INLINE_COMPONENTS = {
    'header.html': [
      ...
      ".nav-btn{position:relative;overflow:hidden;display:inline-flex;align-items:center;background:linear-gradient(135deg,#E86000 0%,#FF7A00 100%);color:#fff;font-family:'Montserrat',sans-serif;font-weight:800;font-size:11px;letter-spacing:2px;text-transform:uppercase;padding:11px 22px;border:none;cursor:pointer;text-decoration:none;border-radius:10px;transition:transform .2s,box-shadow .2s;box-shadow:0 4px 24px rgba(220,90,0,0.5),0 1px 0 rgba(255,255,255,0.15) inset;white-space:nowrap;}",
      ".nav-btn::before{content:'';position:absolute;top:0;left:-100%;width:55%;height:100%;background:linear-gradient(90deg,transparent,rgba(255,255,255,0.22),transparent);transition:left .5s ease;}",
      '.nav-btn:hover{transform:translateY(-1px);box-shadow:0 8px 32px rgba(220,90,0,0.65),0 1px 0 rgba(255,255,255,0.15) inset;}',
    ...
    'footer.html': [
      ...
      '  .foot-top { flex-direction: column; align-items: center; gap: 24px; text-align: center; }',
      '  .foot-brand { align-self: center; margin-right: 0; }',
      '  .foot-links { gap: 20px; justify-content: center; }',
      '  .foot-bar { padding: 14px 20px; }',
      '  .foot-bar-inner { flex-direction: column; align-items: center; gap: 8px; text-align: center; }',
