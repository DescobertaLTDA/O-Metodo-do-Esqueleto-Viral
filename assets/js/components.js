...
(function () {
  ...
  var INLINE_COMPONENTS = {
    'header.html': [
      '<style>',
      'nav{position:fixed;top:0;left:0;right:0;z-index:500;padding:0 20px 0 16px;height:72px;display:flex;align-items:center;gap:12px;background:rgba(4,0,8,0.97);border-bottom:1px solid rgba(255,255,255,0.04);box-shadow:0 1px 0 rgba(201,168,76,0.25),0 8px 32px rgba(0,0,0,0.6);}',
      ...
      '@media(max-width:768px){nav{padding:0 12px 0 10px;height:60px;gap:8px;}.nav-logo-main{font-size:12px;letter-spacing:2px;}.nav-logo-icon{width:28px;height:28px;border-radius:7px;}.nav-btn{font-size:9px;padding:8px 14px;letter-spacing:1px;border-radius:8px;}}',
      '</style>',
      '<nav>',
